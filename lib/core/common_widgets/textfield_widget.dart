  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: hintText,
        hintStyle: TextStyle(
            color: hintTextColor ?? AppConstant.greyColor,
            fontSize: hintFontSize ?? 14,
            fontFamily: hintFontFamily),
        labelStyle: TextStyle(
            color: labelTextColor ?? AppConstant.greyColor,
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              width: 1.5,
              color:
                  focusedBorderColor ?? AppConstant.greyColor.withOpacity(0.3)),
        ),
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              width: 01,
              color:
                  enabledBorderColor ?? AppConstant.greyColor.withOpacity(0.3)),
        ),
      ),
    );
  }
