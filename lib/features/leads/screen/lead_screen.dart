                                      ...
                                      children: [
                                        Expanded(
                                            child: AppUtils.commonTextWidget(
                                                text:
                                                    leadProvider.getAllLeadModel?.data?[index].companyName ?? "",
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              AppUtils.commonContainer(
                                                  ...
                                                  child: ClipOval(
                                                      child: Column(
                                                    children: [
                                                      AppUtils.commonNetworkImageWidget(
                                                          height: 25,
                                                          width: 25,
                                                          boxFit: BoxFit.cover,
                                                          path: profileImage,
                                              ...
                                              Expanded(
                                                  child:
                                                      AppUtils.commonTextWidget(
                                                          text:   leadProvider.getAllLeadModel?.data?[index].customerName ?? "",
                                                          textColor: AppConstant
                                                              .blackColor
                                                              .withOpacity(0.5),
                                                          fontWeight:
                                        ...
                                        Expanded(
                                          child: AppUtils.commonContainer(
                                              ...
                                              child: Center(
                                                  child: AppUtils.commonTextWidget(
                                                      text:  "Last updated: ${AppUtils.getDate(date: leadProvider.getAllLeadModel?.data?[index].modifiedOn ?? "", format: "dd MMM yyyy HH:mm a")}",
